...
<body>
<header>
    <h1>Bienvenido a la Gestión de Libros</h1>
</header>
<nav>
    <ul>
...
<main>
    <section>
        ...
        <p>Esta aplicación permite gestionar libros y sus categorías en la Universidad de La Frontera. Puede agregar, buscar, y eliminar libros de la base de datos.</p>
    </section>
</main>
<footer>
